...
class SdnIpTopo( Topo ):
    ...
    def build( self ):
        ...
        west1 = self.addSwitch('sw1', dpid='00000000000000a1')
        west2 = self.addSwitch('sw2', dpid='00000000000000a2')
        # Add core switches
        core1 = self.addSwitch('sw3', dpid='00000000000000a3')
        core2 = self.addSwitch('sw4', dpid='00000000000000a4')
        
        # Add eastern region switches
        east1 = self.addSwitch('sw5', dpid='00000000000000a5')
        east2 = self.addSwitch('sw6', dpid='00000000000000a6')
        ...
        attachmentSwitches = [west1, west2, east1, east2]

        for i in range(1, 4+1):
            name = 'AS%sr1' % i

            eth0 = { 'mac' : '00:00:00:01:0%s:01' % i,
                     'ipAddrs' : ['10.1.1.%s/24' % i] }
